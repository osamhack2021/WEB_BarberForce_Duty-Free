...
<ul>
  ...
  <li>
    🩺 ‘위드 코로나’ 상황에서 외출·외박이 시행될 경우 병사 외출의 가장 많은 사유는 ‘이발’입니다. 돌파감염의 방지가 중요한 현재 상황에서 <b>바버포스</b>는 <b>병력의 효율적인 방역관리</b>에 도움을 줍니다.
    <ul>
      <li>
  ...
  <li>
    🔒 <b>바버포스</b>는 상권의 위치정보만을 활용하며, 군 내 정보나 인트라넷 체계, 또는 별도의 전자기기를 사용하지 않는 프로젝트입니다.
    <ul>
      <li>따라서, <b>부대 및 병영 내 정보통신장비 보안위규 문제에서 자유롭습니다.</b></li>
    </ul>
  </li>
  <li>
    💬 ‘머리깎고 뭐하지?’ 게시판을 활용해 지역상권 내 편의시설 방문 후기를 작성하고 공유할 수 있는 체계를 구축합니다.
    <ul>
      <li><b>병사 이발외출 수요로 부대 인근 지역상권에 보탬</b>이 되며, 병사들간의 건전한 소통 창구를 마련합니다.
      </li>
    </ul>
  </li>
  <li>
